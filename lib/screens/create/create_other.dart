...
class CreateOther extends StatefulWidget {
  const CreateOther({Key? key}) : super(key: key);

  @override
  State<CreateOther> createState() => _CreateOtherState();
}

class _CreateOtherState extends State<CreateOther> {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget> [
                      ...
                      const SizedBox(height: 20),
                      ElevatedButton(onPressed: addModule, child: const Text("Add Entry")),
    ...
    try {
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              content: const Text("Would you like to add another entry?"),
              actions: [
                TextButton(
                    onPressed: () {
                      setState(() {
